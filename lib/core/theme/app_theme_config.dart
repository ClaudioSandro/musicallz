...
class ThemePalette {
  ...
  ThemePalette light() {
    ...
    return ThemePalette(
      ...
      primary: primary,
      secondary: secondary,
      background: _mixWithWhite(primary, 0.94, 0xF7F7F7),
      surface: _mixWithWhite(primary, 0.9, 0xFFFFFF),
      surfaceHigh: _mixWithWhite(primary, 0.82, 0xEEEEEE),
      card: _mixWithWhite(primary, 0.86, 0xF0F0F0),
      icon: _dark(0x4A4A4A),
      text: _dark(0x1A1A1A),
      textSecondary: _dark(0x666666),
